...
const line1 = splitToLetters("Welcome to");
const line2 = splitToLetters("Play House!");

const Banner = () => {
    return (
        <section className="relative isolate w-full overflow-hidden transition-colors duration-300">
            ...
            {/* Main content — text on top (mobile), text left / animation right (desktop) */}
            <div className="relative z-10 mx-auto flex min-h-[500px] w-[92%] max-w-full flex-col items-center justify-between gap-5 py-8 sm:min-h-[580px] sm:w-[90%] sm:flex-row sm:gap-8 sm:py-10 md:min-h-[620px] md:py-12 lg:min-h-[650px] lg:gap-12 lg:py-14 xl:min-h-[680px]">
                ...
                {/* LEFT CONTENT */}
                <div className="relative z-20 order-1 flex w-full flex-col items-center text-center sm:w-[48%] sm:items-start sm:text-left lg:w-[47%]">
                        ...
                        >
                            {line2.map((char, i) => (
                                <motion.span
                                    ...
                                    transition={{ duration: 0.42, delay: 0.5 + i * 0.045, ease: [0.22, 1, 0.36, 1] }}
                                    className="inline-block"
                                    style={{ filter: "drop-shadow(0 7px 18px rgba(214,140,15,0.25))" }}
                                >
                                    {char}
                                </motion.span>
                            ))}
                ...
                dark:text-[#1E2B2B]
                shadow-[0_12px_28px_-8px_rgba(15,82,87,0.45)]
              "
                        >
                            <span>Shop Now</span>
                        </Link>
                ...
                <motion.div
                    ...
                    className="relative order-2 flex w-full items-center justify-center sm:w-[52%] lg:w-[53%]"
                >
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(to top, var(--ph-bg), transparent)",
                    opacity: 0.7,
                }}
            />
        </section>
