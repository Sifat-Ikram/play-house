...
const Banner = () => {
    return (
        ...
        >
            ...
            {/* Main content */}
            <div className="relative z-10 mx-auto flex min-h-[500px] w-[92%] max-w-[1380px] flex-col items-center justify-between gap-5 py-8 sm:min-h-[580px] sm:w-[90%] sm:flex-row sm:gap-8 sm:py-10 md:min-h-[620px] md:py-12 lg:min-h-[650px] lg:gap-12 lg:py-14 xl:min-h-[680px]">
